...
public class HomeBasedChallengeCategoryFragment extends Fragment implements GymChallengeCategoryAdapter.ItemClicked, View.OnClickListener {
    private View main;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        main = inflater.inflate(R.layout.home_based_challenge_category, container, false);
...
//        ft.addToBackStack(null);
    ...
    public void onClick(View v) {
        if (v.getId()==R.id.rlChallenges1){
            ...
            bundl.putString("category", "Challenge-1");

            HomeBasedChallengeStartFragment dv = new HomeBasedChallengeStartFragment();
            dv.setArguments(bundl);
            replaceFragment(dv);

        }if (v.getId()==R.id.rlChallenges2){
            Bundle bundl = new Bundle();
            bundl.putString("category", "Challenge-2");
            ...
            Bundle bundl = new Bundle();
            bundl.putString("category", "Challenge-3");

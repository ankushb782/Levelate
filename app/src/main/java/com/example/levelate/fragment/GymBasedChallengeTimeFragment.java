...
public class GymBasedChallengeTimeFragment extends Fragment implements View.OnClickListener {
    private View main;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        main = inflater.inflate(R.layout.gym_based_beat_challenge, container, false);
    ...
    public void onClick(View v) {
        if (v.getId()==R.id.btnBeatTime){
            ...
            GymBasedSubmitChallengeFragment dv = new GymBasedSubmitChallengeFragment();

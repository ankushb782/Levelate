...
public class JournalQuestionFragment extends Fragment implements View.OnClickListener {
    private View main;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        main = inflater.inflate(R.layout.frag_journal_question,container,false);
    ...
    public void onClick(View v) {
        if (v.getId()==R.id.btnNext){
            ...
            JournalQuestionSecondFragment journalQuestionFragment = new JournalQuestionSecondFragment();

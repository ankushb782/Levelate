...
public class GymBasedChallengeCategoryFragment extends Fragment implements GymChallengeCategoryAdapter.ItemClicked, View.OnClickListener {
    private View main;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        main = inflater.inflate(R.layout.gym_based_challenge_category, container, false);
...
//        ft.addToBackStack(null);
    ...
    public void onClick(View v) {
        if (v.getId()==R.id.rlChallenges1){
            ...
            GymChallengeStartFragment dv = new GymChallengeStartFragment();

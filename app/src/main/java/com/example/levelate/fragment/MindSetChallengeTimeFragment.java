...
public class MindSetChallengeTimeFragment extends Fragment implements View.OnClickListener {
    private View main;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        main = inflater.inflate(R.layout.mindset_based_beat_challenge, container, false);
    ...
    public void onClick(View v) {
        if (v.getId()==R.id.btnBeatTime){
            ...
            MindSetSubmitChallengeFragment dv = new MindSetSubmitChallengeFragment();

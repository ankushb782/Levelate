...
public class WeeklyMindsetFragment extends Fragment implements WeeklyDataAdapter.SingleClicked {
    private View main;
    ArrayList<WeeklySectionModel> weeklySectionModels;
    private RecyclerView my_recycler_view;
    private boolean homeChallenge;
    private TextView tvHeading;
    public WeeklyMindsetFragment() {
        // Required empty public constructor
    }

    public static WeeklyMindsetFragment newInstance(String param1, String param2) {
        WeeklyMindsetFragment fragment = new WeeklyMindsetFragment();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        main = inflater.inflate(R.layout.frag_week_mindset, container, false);
    ...
    public void onSingleItemClicked(CharSequence txt) {
        ...
        ft.replace(R.id.fragment_frame, new WeeklyMidsetStartFragment(), "NewFragmentTag");

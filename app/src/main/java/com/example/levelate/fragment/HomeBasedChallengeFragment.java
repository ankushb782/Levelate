...
public class HomeBasedChallengeFragment extends Fragment implements WeeklyDataAdapter.SingleClicked {
    private View main;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        main = inflater.inflate(R.layout.frag_home_based_challenge, container, false);
    ...
    public void onSingleItemClicked(CharSequence txt) {
        ...
        ft.replace(R.id.fragment_frame, new HomeBasedChallengeCategoryFragment(), "NewFragmentTag");

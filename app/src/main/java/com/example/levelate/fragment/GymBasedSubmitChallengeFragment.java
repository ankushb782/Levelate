...
public class GymBasedSubmitChallengeFragment extends Fragment implements View.OnClickListener {
    private View main;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        main = inflater.inflate(R.layout.gym_submit_challenge,container,false);
